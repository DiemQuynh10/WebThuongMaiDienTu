...
{
    /// <inheritdoc />
    public partial class VariantsRefactor : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "DanhMucs",
                columns: new[] { "Id", "DanhMucChaId", "HienThi", "MoTa", "Slug", "Ten", "ThuTu" },
                values: new object[,]
                {
                    { 1, null, true, null, "dien-thoai", "Dien thoai", 1 },
                    { 2, null, true, null, "laptop", "Laptop", 2 },
                    { 3, null, true, null, "thoi-trang", "Thoi trang", 3 },
                    { 4, null, true, null, "giay-dep", "Giay dep", 4 },
                    { 5, null, true, null, "phu-kien", "Phu kien", 5 },
                    { 6, null, true, null, "my-pham", "My pham", 6 }
                });
